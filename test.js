...
var questions = [
    {ques: "First question?",
     choice: ["choiceOne", "choiceTwo", "choiceThree", "choiceFour"],
     answer: "choiceOne"
    },
...
function tester(){
    ...
    {
    quiz.innerHTML = questions[0].ques;
    ...
    document.getElementById('btn-one').addEventListener("click", function(event){
        ...
        this.onclick= document.write("hiya");
    ...
    document.getElementById('btn-two').addEventListener("click", function(event){
        event.preventDefault();
        this.onclick= document.write("holaaa");
    ...
    document.getElementById('btn-three').addEventListener("click", function(event){
        event.preventDefault();
        this.onclick= document.write("heylooooo");
    ...
    document.getElementById('btn-four').addEventListener("click", function(event){
        event.preventDefault();
        score++
        this.onclick= document.write(score);
...
//VER 2 (Button is next button is clear after score is showed)--------------------------------------------------------------------------------------------------------------------------------
...
function tester(){
    ...
    document.getElementById('btn-four').addEventListener("click", function(event){
        ...
        document.getElementById('nxt-button').addEventListener("click", function(event){
            event.preventDefault();
            this.onclick= testerTwo(); this.style = 'block'; this.style.display = 'none';
...
//VER 3 (flips through each question and increments score)---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
//QUESTION 2
    ...
    {
        quiz.innerHTML = questions[1].ques;
...
function questionThree(){
    {
        quiz.innerHTML = questions[2].ques;
...
function congrats(){
    if(score===1||score===-1){
    document.write("Winner! Your score is: "+ score + " point");
    }else{document.write("Winner! Your score is: "+ score + " points")};
...
//VER 5(able to store in local storage)-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function startTime(){
    ...
    function countZ(){
       document.write('The count is Zero! Your score is ' + score)
        ...
        listCon.setAttribute("id", "hScoreList")
...
event.preventDefault();
        ...
        var nameString = JSON.stringify(nameVal);
...
//VER 6(highscore list for names)------------------------------------------------------------------------------------------------------------------------------------------------------
...
event.preventDefault();
        ...
        lisItem.innerHTML= storedName + storedEmail;
...
//VER 8(all bugs fixed, w/o new quesitons and increment/decrement changes)--------------------------------------------------------------------------------------------------------------------------------------------
...
function startTime(){
    ...
    var questions = [
        ...
        choice: ["Tomato", "Chicken", "*Walking away, now I'm hungry, gonna get a snack", "Radish"],
        answer: "choiceThree"}
    ];
